...
var params0 = {
    ...
    loop: false,
    autoplay: true,
    path: './build/images/animation1.json'
};
var anim0;
anim0 = lottie.loadAnimation(params0);
...
var params1 = {
    ...
    loop: false, 
    autoplay: false,
    path: './build/images/animation2.json'
};
...
var params2 = {
    ...
    loop: false,
    autoplay: false,
    path: './build/images/animation3.json'
};

var anim2;
anim2 = lottie.loadAnimation(params2);

var anims = [anim0, anim1, anim2];
...
window.onload = function(){
    ...
    owl.on('changed.owl.carousel', function(event) {
        anims.map(a => a.goToAndStop(0,true));
        anims[event.item.index].play();
    })
}
